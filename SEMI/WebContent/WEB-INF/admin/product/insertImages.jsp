...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(document).on("change", ".fileSearch", function() {
			...
			$(this).parent().parent().parent().find(".pimages").val(pimages);
		});
		...
		$("#applyImg").click(function() {
			...
			//console.log(addRoot);
			$(opener.document).find("#pimages").val(addRoot);
		//	self.close();
		});
...
<body>
	<div class="container">
		...
		<div class="row clearfix" style="padding-top: 2%; padding-bottom: 2%;">
			<div class="col-md-12">
				<button id="applyImg" class="btn btn-default pull-right"
					...
					<tbody class="tbl-img" id="tbl-img">
						<tr id='addr0' class="imgRow">
							...
							<td><button type="button" class="btnFile form-control btn btn-dark" 
								...
								<span id="imagesPath" class="imagesPath"><input type="file" class="fileSearch" value=""/></span></td>
						</tr>
